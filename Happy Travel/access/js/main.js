...
function Curacao() {
    var1 = '&Ccedil;uracao is een zonnig eiland geschikt voor tourisme. Er zijn er veel mooie hotels en bouwwerken te vinden. Je kan er zwemmen. Dit is &Ccedil;uracao. (Exclusief gidswandeling)';
    document.getElementById("mini_content_ss").innerHTML = var1;
    document.getElementById("mini_content_ss_mobile").innerHTML = var1;
}
function NY() {
    var1 = "New York is een stad in Amerika. De stad heeft veel geschiedenis en is hypermodern. Zo heb je er veel kantoren en veel flats. New York is echt een drukke en grote stad waar ook veel restaurants zijn en waar ook overal wel wat te beleven valt. Dit is New York. (Gidswandeling inbegrepen)";
    document.getElementById("mini_content_ss").innerHTML = var1;
    document.getElementById("mini_content_ss_mobile").innerHTML = var1;
}
...
//Last Minute
function Colombia() {
    var1 = "(Deze reis is beschikbaar tot morgen om 12:30) 'Colombia is een ideale stad om drugs te dealen!' ~ (Ft. Pablo) Verder is Colombia een mooie en zonnige stad om je vakantie te vieren! Er zijn veel verschillende culturen in Colombia en daardoor valt er veel te beleven. Al vanaf &euro;321. Ga naar tickets om uw last minute ticket te halen! Dit is Colombia!";
    document.getElementById("main_txt_lm").innerHTML = var1;
}
function Zwitserland() {
    var1 = "(Deze reis is beschikbaar tot vrijdag om 14:15) Zwitserland staat vooral bekend om zijn wintersporttourisme. Je kan er in de winter ski&euml;n, snowboarden en langlaufen. Al vanaf &euro;240. Ga naar tickets om uw last minute ticket te halen! Dit is Zwitserland!";
    document.getElementById("main_txt_lm").innerHTML = var1;
}
function Parijs() {
    var1 = "(Deze reis is beschikbaar tot dinsdag om 23:19) Parijs is een van de bekendste locaties van heel Europa! De stad ligt in Frankrijk en staat voornamelijk bekend om de Eifeltoren! Al vanaf &euro;410. Ga naar tickets om uw last minute tickets te halen! Dit is Parijs!";
    document.getElementById("main_txt_lm").innerHTML = var1;
}
function Alpen() {
...
function Lapalma() {
    var1 = "(Deze reis is beschikbaar tot woensdag om 14:25) La Palma is een zonnig eiland in Spanje. Je hebt er veel tourisme en het eiland heeft zelfs zijn eigen cultuur. Ook heeft het eiland een bijzondere natuur. Zo zijn er planten en dieren die ergens anders zeldzaam zijn. Al vanaf &euro;320. Ga naar tickets om uw last minute tickets te halen! Dit is La Palma!";
    document.getElementById("main_txt_lm").innerHTML = var1;
}
function Cyprus() {
    var1 = "(Deze reis is beschikbaar tot maandag om 17:28) Cyprus is een eiland gelegen in de Middelandse Zee. Het land ligt tussen Turkije en Syri&euml; in. Het land heeft twee politieken en je kan er mooi buiten zitten. Ook heb je er veel water activiteiten. Al vanaf &euro;305 Ga naar tickets om uw last minute tickets te halen! Dit is Cyprus!";
    document.getElementById("main_txt_lm").innerHTML = var1;
}
//Verre Reizen
function India() {
    var1 = "India is een groot land met grote en vele culturen. Het land heeft ook veel geloven. Je kan er ook komen voor de natuur die er ondanks de drukke steden ook is. Al vanaf &euro;490 kunt u voor een midweek in dit gebouw doorbrengen. Ga naar tickets om uw reis te boeken! Dit is India!";
    document.getElementById("mini_content_ss").innerHTML = var1;
}
function Japan() {
